...
The authoritative inventory is [Documentation Render Tracking](../../docs/testing/DOCUMENTATION_RENDER_TRACKING.md). That document tracks promoted static infographics, promoted live UI renders, and any future open screenshot slots marked in target docs with `<Render Needed>`.
