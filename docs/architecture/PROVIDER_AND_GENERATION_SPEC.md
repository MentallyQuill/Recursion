...
| `editorialVerifier` | Reasoner at High/Ultra; Utility fallback when Reasoner unavailable | Return binary accept/reject for one already-validated full candidate | No rewrite, ranking, alternate candidate, or structured correction request. |
