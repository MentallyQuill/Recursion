...
| Character | Active Cast, Character Motivation, Relationship, Social Subtext, Realism, Knowledge. |
...
- Focus: Character. Prefer Active Cast, Character Motivation, Relationship, Social Subtext, Realism, and Knowledge when relevant; do not ignore critical non-character scene constraints.
...
```json
{
  "behaviorPolicy": {
    ...
    "boostedFamilies": ["Active Cast", "Character Motivation", "Relationship", "Social Subtext", "Realism", "Knowledge"],
