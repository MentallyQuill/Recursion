...
## Make every turn more yours.

Recursion `0.1.0-pre-alpha.6` puts the story back in your hands with two major additions: **Custom Decks & Cards** for shaping the questions Recursion asks about your scene, and **Post-Processing** for giving completed responses a second, smarter pass.

This is the release where Recursion stops being just background scene support and becomes an active creative tool: define what matters, guide how it is considered, then refine the response without losing the original.

## Custom Decks & Cards

Build the story engine around the way you actually play.

Duplicate a deck, create your own categories, write cards in your own words, and arrange everything in the order that makes sense for your campaign. Keep the bundled catalog as a starting point or make something completely personal for a character, faction, location, relationship, or style of play.

Cards now give you a much more expressive way to steer a turn:
...
Your deck is not just a settings list. It is your reusable lens on the story.

![Current Pre-process Cards panel](../../assets/documentation/renders/recursion-pre-process-cards-panel.png)

## Post-Processing

Sometimes a response is almost right. Now you can do something about it.
...
The result is a safer, more flexible way to polish a turn: revise the pacing, sharpen character intent, strengthen continuity, or redirect the response while keeping the original within reach.
