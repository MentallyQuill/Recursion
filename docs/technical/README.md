...
| [Runtime Turn Sequence](RUNTIME_TURN_SEQUENCE.md) | Power toggle, Auto, and Semi-Auto lifecycle from snapshot capture through Arbiter decisions, cards, composition, injection, storage, cancellation, and failure branches. |
