...
API keys are session-only. Raw chat text, provider prompts and responses, hidden reasoning, credentials, cookies, and stack traces do not belong in manifests, journals, reports, or verification artifacts.
