...
| `recursion-operator-pipeline-controls.png` | live host | `docs/user/RECURSION_OPERATOR_MANUAL.md` | Segmented/Fused pipeline dropdown in the compact Recursion Bar, including both visible options. |
...
| `recursion-operator-provider-controls.png` | live host | `docs/user/RECURSION_OPERATOR_MANUAL.md` | Provider controls showing Utility fallback warning, derived Reasoner capability, session-key affordances, and provider test status. |
...
| `recursion-operator-fused-repair-progress.png` | live host | `docs/user/RECURSION_OPERATOR_MANUAL.md` | Hero Pixel Array progress menu showing accepted Fused bundle cards plus targeted Segmented repair for a damaged or missing sibling. |
