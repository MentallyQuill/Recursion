...
- [Testing Strategy](TESTING_STRATEGY.md): three-layer verification stack, card/editorial proof matrix, core invariants, dedicated live-user policy, pass/fail semantics, and V1 non-goals.
