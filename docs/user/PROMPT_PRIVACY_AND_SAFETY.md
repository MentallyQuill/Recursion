...
![Prompt Packet viewer showing instruction-shaped Card Evidence, Guidance status, and sanitized route metadata](../../assets/documentation/renders/recursion-prompt-packet-instruction-card-evidence.png)
