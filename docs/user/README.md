...
- [First Run Workflow](FIRST_RUN_WORKFLOW.md) - Short first-session path from install and provider setup through Standard Auto, Manual, Rapid trial, inspection, and power-toggle cleanup.
- [Recursion Operator Manual](RECURSION_OPERATOR_MANUAL.md) - Complete practical manual for normal operation, UI surfaces, Standard/Rapid pipelines, modes, settings, diagnostics, storage actions, mobile behavior, and smoke checks.
