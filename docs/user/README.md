...
- [Recursion Operator Manual](RECURSION_OPERATOR_MANUAL.md) - Complete practical manual for normal operation, Pre-process and Post-process Cards, Standard/Rapid/Fused pipelines, modes, Tense & PoV, settings, diagnostics, storage actions, mobile behavior, and smoke checks.
