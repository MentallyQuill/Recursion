...
- [First Run Workflow](FIRST_RUN_WORKFLOW.md) - Short first-session path from install and provider setup through Auto, Manual, inspection, and power-toggle cleanup.
