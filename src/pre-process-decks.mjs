...
export const DEFAULT_PRE_PROCESS_CARD_DESCRIPTIONS = Object.freeze({
  ...
  'sceneFrameCard:beatConstraint': 'Preserves established limits without inventing delays or freezing progress.',
  ...
  'characterMotivationCard:visibleGoals': 'Connects personal stakes to relevant questions and actions.',
  'characterMotivationCard:pressures': 'Tracks external, social, tactical, and emotional pressures shaping current behavior.',
  'characterMotivationCard:hesitationPosture': 'Allows doubt, listening, and practical cooperation to coexist.',
  'dialogueRelationshipCard:tension': 'Distinguishes belief, trust, personal concern, and willingness to help.',
  ...
  'realismCard:presentStakes': 'Keeps responses engaged with what matters to each character now.',
  'realismCard:surpriseSenseMaking': 'Turns uncertainty into relevant clarification without forcing belief or impossible proof.',
  ...
  'knowledgeSecretsCard:knowsSuspects': 'Tracks interpretations, uncertainty, and what characters can reasonably learn.',
  'knowledgeSecretsCard:revealBoundaries': 'Protects unknown truths while allowing clarification and tentative decisions.',
