...
const PHASE_LABELS = Object.freeze({
  ...
  sceneChecking: 'Reading current turn...',
  arbiterPlanning: 'Planning card pass...',
  cacheReusing: 'Reusing turn work...',
  ...
  deckUpdating: 'Building turn deck...',
  ...
  storageSaving: 'Saving turn checkpoints...',
  storageComplete: 'Turn checkpoints saved.',
  ...
  cacheWarning: 'Ignored invalid saved Recursion work.',
