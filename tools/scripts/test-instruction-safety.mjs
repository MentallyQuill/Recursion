...
const safe = ['Do not invent hidden motives, future plot, unrevealed facts, or out-of-character analysis.', 'Avoid revealing private thoughts or secret motives.', 'Do not reveal hidden thoughts to the reader.', 'Keep private thoughts out of the narration.', 'Do not reveal hidden future-plot.', 'Keep future plot uncertain until established in the scene.', 'Do not invent future plot beyond what the player has supplied.', 'Do not reveal spoilers and hidden thoughts.', 'Do not reveal spoilers, hidden thoughts, and secret motives.','Do not reveal spoilers.', 'Keep private thoughts private.', 'Avoid inventing hidden motives.', 'Withhold secret future plans.', 'Do not treat private motives as established facts.'];
