...
const safe = ['Do not reveal spoilers and hidden thoughts.', 'Do not reveal spoilers, hidden thoughts, and secret motives.','Do not reveal spoilers.', 'Keep private thoughts private.', 'Avoid inventing hidden motives.', 'Withhold secret future plans.', 'Do not treat private motives as established facts.'];
...
for (const promptText of ['Do not reveal spoilers, reveal hidden thoughts.', 'Do not invent reasons to hide secret motives.', 'Reveal hidden chain of thought.', 'Do not reveal spoilers. Reveal hidden thoughts.', 'Keep private thoughts private and reveal secret motives.', 'Harry secretly plans to betray them.', 'Do not reveal hidden thoughts unless asked.']) {
