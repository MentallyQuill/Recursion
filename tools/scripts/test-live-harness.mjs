...
async function createSillyTavernSmokeFixtureServer({
  ...
  const moduleFiles = [
    ...
    'src/post-process-decks.mjs',
    'src/post-process-guidance.mjs',
    'src/post-process-editing.mjs',
    'src/post-process-comparison.mjs',
    'src/post-process-review.mjs',
    'src/ui/post-process-review.mjs',
    'src/hosts/sillytavern/post-process-profile-writer.mjs',
    'src/post-process-runtime.mjs',
    'src/card-scope.mjs',
    'src/card-selection.mjs',
    'src/card-refinement.mjs',
    'src/cards.mjs',
    ...
    'src/guidance-omissions.mjs',
    'src/story-form.mjs',
    'src/ui/action-status.mjs',
    'src/ui/bar.mjs',
    'src/ui/cards-panel.mjs',
