...
await router.generate('fusedCardBundle', { prompt: 'Fused card bundle' });
assertEqual(calls.at(-1).lane, 'utility', 'fusedCardBundle uses utility lane');
assertEqual(calls.at(-1).responseSchema, 'recursion.cardBundle.v1', 'fusedCardBundle request carries expected response schema');
